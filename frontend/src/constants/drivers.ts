...
export const F1_DRIVERS: Driver[] = [
  ...
  { code: 'HUL', name: 'Nico Hulkenberg', seasons: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2022, 2023, 2024, 2025], teams: ['Sauber'] },
  ...
  { code: 'ANT', name: 'Andrea Kimi Antonelli', seasons: [2025], teams: ['Mercedes'] },
  { code: 'HAD', name: 'Isack Hadjar', seasons: [2025], teams: ['Racing Bulls'] },
  { code: 'BOR', name: 'Gabriel Bortoleto', seasons: [2025], teams: ['Sauber'] },
