...
export const F1_DRIVERS: Driver[] = [
  // Current 2025 Grid (Updated - removed Bottas and Perez)
  { code: 'VER', name: 'Max Verstappen', seasons: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025], teams: ['Red Bull Racing'] },
  { code: 'LAW', name: 'Liam Lawson', seasons: [2023, 2024, 2025], teams: ['Red Bull Racing'] },
  ...
  { code: 'ANT', name: 'Kimi Antonelli', seasons: [2025], teams: ['Mercedes'] },
  ...
  { code: 'TSU', name: 'Yuki Tsunoda', seasons: [2021, 2022, 2023, 2024, 2025], teams: ['Racing Bulls'] },
  { code: 'HAD', name: 'Isack Hadjar', seasons: [2025], teams: ['Racing Bulls'] },
  { code: 'GAS', name: 'Pierre Gasly', seasons: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025], teams: ['Alpine'] },
  { code: 'DOO', name: 'Jack Doohan', seasons: [2025], teams: ['Alpine'] },
  { code: 'OCO', name: 'Esteban Ocon', seasons: [2016, 2017, 2018, 2020, 2021, 2022, 2023, 2024, 2025], teams: ['Haas'] },
  ...
  { code: 'COL', name: 'Franco Colapinto', seasons: [2024, 2025], teams: ['Kick Sauber'] },
  { code: 'BEA', name: 'Oliver Bearman', seasons: [2024, 2025], teams: ['Kick Sauber'] },

  // Recent/Former Drivers (2018-2024) - Bottas and Perez moved here
  ...
  { code: 'BOT', name: 'Valtteri Bottas', seasons: [2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024], teams: ['Kick Sauber'] },
  ...
  { code: 'MAG', name: 'Kevin Magnussen', seasons: [2014, 2015, 2016, 2017, 2022, 2023, 2024], teams: ['Haas'] },
  { code: 'ZHO', name: 'Zhou Guanyu', seasons: [2022, 2023, 2024], teams: ['Kick Sauber'] },
];
